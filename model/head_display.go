...
JSON Sample
-------------------------------------
{    "id": "ElymRioKPGQdwgkkCxMeOniBi",    "device_name": "isoNRbibfwMUkcIKkHBeKlPmO",    "device_no": "StbLDBTawVcpjakAlnDZhwTuJ",    "model": "FlmUFyHqvOtUxJEVyVJKwUnMc",    "ward_id": "AifYeeashIqSCnWksMIWdGMaA"}
