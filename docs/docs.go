    ...
    "paths": {
        ...
        "/camera/livestream/preview": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Camera livestream preview request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.Head_display"
                                            }
                                        }
                                    }
                                }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.Visit_record_live_info"
                                            }
                                        }
                                    }
                                }
        ...
        "/visit-record-live-record": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "visit_record_id",
                        "name": "visit_record_id",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "live_record_id",
                        "name": "live_record_id",
                        "in": "query"
                    }
                ],
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.Visit_record_live_record"
                                            }
                                        }
                                    }
                                }
        ...
        "/visit-record-live-record/batch-delete": {
            "post": {
                "description": "batch delete",
                "consumes": [
                    "application/json"
        ...
        "/visit-record-live-record/batch-upsert": {
            "post": {
                "description": "batch update",
                "consumes": [
                    "application/json"
    ...
    "definitions": {
        ...
        "model.Bed": {
            ...
            "properties": {
                ...
                "vr_camera_id": {
                    "description": "VR摄像头ID(可关联固定VR摄像头)",
                    "type": "string"
                },
                "ward_id": {
                    "description": "病房ID",
        ...
        "model.Visit_record": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "状态(0:正常,1:取消,2:已结束)",
                    "type": "integer"
                },
                "visit_end_time": {
                    "description": "探视结束时间",
        ...
        "model.Visit_record_live_record": {
            "type": "object",
            "properties": {
                "id": {
                    "description": "关联ID",
