...
Table: v_visit_record_live_info
...
[20] live_records                                   JSON                 null: true   primary: false  isArray: false  auto: false  col: JSON            len: -1      default: []


JSON Sample
-------------------------------------
{    "id": "hBcKuqqbCVbghGhSBEOrmnRXZ",    "patient_id": "XqHpijtoUaVxAAnlIcSVVNsLm",    "relative_id": "jAtbrOTDsbiFWrtqAQgIhnixi",    "visit_start_time": 26,    "visit_end_time": 72,    "visitor_name": "ihfcTJKeDEFbIXGXfJNqhvbJZ",    "visitor_phone": "nwLasnSMNMIUmqEKFnRRsIyaV",    "visitor_id_card": "MYIIseyCGNgVTblerXpcBqGvC",    "relationship": "nWghDTlkbHtGsGZrHHAqRfgRV",    "camera_id": "dZXSNyYbonQlelSZrEvNQXPVf",    "vr_camera_id": "DnaHyxxbaBlTbHGlNcYhjqlHo",    "check_status": 94,    "status": 15,    "remark": "OTbLUFdcmttbvTqAOuNhPrOjy",    "send_sms_status": 79,    "send_prompt_sms_status": 28,    "schedule_id": "SjudgEMPsLBCoESIQAwxWOUIT",    "patient_name": "LIwsTrPjrfXTcQoulfrQyBZHR",    "patient_ward_name": "UjbJvQIThtpRjqOrmpCvdrXHf",    "patient_bed_no": "rPgrWDqsudjkYbXBJDUvDbkKl",    "live_records": 55}


Comments
-------------------------------------
[ 0] Warning table: v_visit_record_live_info does not have a primary key defined, setting col position 1 id as primary key
Warning table: v_visit_record_live_info primary key column id is nullable column, setting it as NOT NULL
...
var (
	Visit_record_live_info_FIELD_NAME_id = "id"

	Visit_record_live_info_FIELD_NAME_patient_id = "patient_id"

	Visit_record_live_info_FIELD_NAME_relative_id = "relative_id"

	Visit_record_live_info_FIELD_NAME_visit_start_time = "visit_start_time"

	Visit_record_live_info_FIELD_NAME_visit_end_time = "visit_end_time"

	Visit_record_live_info_FIELD_NAME_visitor_name = "visitor_name"

	Visit_record_live_info_FIELD_NAME_visitor_phone = "visitor_phone"

	Visit_record_live_info_FIELD_NAME_visitor_id_card = "visitor_id_card"

	Visit_record_live_info_FIELD_NAME_relationship = "relationship"

	Visit_record_live_info_FIELD_NAME_camera_id = "camera_id"

	Visit_record_live_info_FIELD_NAME_vr_camera_id = "vr_camera_id"

	Visit_record_live_info_FIELD_NAME_check_status = "check_status"

	Visit_record_live_info_FIELD_NAME_status = "status"

	Visit_record_live_info_FIELD_NAME_remark = "remark"

	Visit_record_live_info_FIELD_NAME_send_sms_status = "send_sms_status"

	Visit_record_live_info_FIELD_NAME_send_prompt_sms_status = "send_prompt_sms_status"

	Visit_record_live_info_FIELD_NAME_schedule_id = "schedule_id"

	Visit_record_live_info_FIELD_NAME_patient_name = "patient_name"

	Visit_record_live_info_FIELD_NAME_patient_ward_name = "patient_ward_name"

	Visit_record_live_info_FIELD_NAME_patient_bed_no = "patient_bed_no"

	Visit_record_live_info_FIELD_NAME_live_records = "live_records"
)

// Visit_record_live_info struct is a row record of the v_visit_record_live_info table in the  database
type Visit_record_live_info struct {
	...
	Relationship string `json:"relationship"` //探视人与患者关系

	CameraID string `json:"camera_id"` //床头摄像头ID

	VrCameraID string `json:"vr_camera_id"` //VR摄像头ID

	CheckStatus int32 `json:"check_status"` //审核状态
	...
	LiveRecords any `json:"live_records"` //直播记录列表

}

var Visit_record_live_infoTableInfo = &TableInfo{
	Name: "v_visit_record_live_info",
	Columns: []*ColumnInfo{
		...
		&ColumnInfo{
			...
			Name:    "id",
			Comment: `探视记录ID`,
			Notes: `Warning table: v_visit_record_live_info does not have a primary key defined, setting col position 1 id as primary key
Warning table: v_visit_record_live_info primary key column id is nullable column, setting it as NOT NULL
`,
			Nullable:           false,
		...
		&ColumnInfo{
			...
			ColumnType:         "JSON",
			ColumnLength:       -1,
			GoFieldName:        "LiveRecords",
			GoFieldType:        "any",
			JSONFieldName:      "live_records",
			ProtobufFieldName:  "live_records",
			ProtobufType:       "string",
			ProtobufPos:        21,
		},
	},
...
func (v *Visit_record_live_info) TableName() string {
	return "v_visit_record_live_info"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (v *Visit_record_live_info) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (v *Visit_record_live_info) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (v *Visit_record_live_info) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (v *Visit_record_live_info) TableInfo() *TableInfo {
	return Visit_record_live_infoTableInfo
}
