...
func InitVisit_record_live_infoRoute(r chi.Router) {

	r.Get(common.BASE_CONTEXT+"/visit-record-live-info/page", Visit_record_live_infoPageListHandler)
	r.Get(common.BASE_CONTEXT+"/visit-record-live-info", Visit_record_live_infoListHandler)
...
// @Param live_records query string false "live_records"
// @Produce  json
// @Success 200 {object} common.Response{data=common.Page{items=[]model.Visit_record_live_info}} "objects array"
// @Failure 500 {object} common.Response ""
// @Router /visit-record-live-info/page [get]
func Visit_record_live_infoPageListHandler(w http.ResponseWriter, r *http.Request) {
	...
	common.CommonPageQuery[model.Visit_record_live_info](w, r, common.GetDaprClient(), "v_visit_record_live_info", "id")
...
// @Param live_records query string false "live_records"
// @Produce  json
// @Success 200 {object} common.Response{data=[]model.Visit_record_live_info} "objects array"
// @Failure 500 {object} common.Response ""
// @Router /visit-record-live-info [get]
func Visit_record_live_infoListHandler(w http.ResponseWriter, r *http.Request) {
	common.CommonQuery[model.Visit_record_live_info](w, r, common.GetDaprClient(), "v_visit_record_live_info", "id")
}
