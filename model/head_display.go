...
JSON Sample
-------------------------------------
{    "id": "RRgirpEQoWNnksWwTFlgDXSqt",    "device_name": "aPeckPDRoKrhHIhdEaCVrWJli",    "device_no": "GKCBkkrmUUwLelCSSeNeULBRY",    "model": "eyiqcbflPjCFoWTfsaMxdUUJp",    "ward_id": "QmEffRioVEWkAdcvcGuABldIL"}
